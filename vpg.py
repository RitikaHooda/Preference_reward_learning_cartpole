...
def train(env_name='CartPole-v0', hidden_sizes=None, lr=1e-2,
    ...
    for i in range(epochs):
        ...
        if checkpoint:
            ...
            torch.save(logits_net.state_dict(), os.path.join(checkpoint_dir, f"policy_checkpoint{i}.params"))

    if not checkpoint:
        torch.save(logits_net.state_dict(), os.path.join(checkpoint_dir, "final_policy.params"))
